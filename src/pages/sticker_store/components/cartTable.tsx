...
const CartTable = () => {
  const cart: CartItem[] = useSelector((state: RootState) => selectAll(state.cart));
                ...
                {cart.map((item: CartItem) => (
                  ...
                  >
                    ...
                    <td className="font-primary font-medium px-4 sm:px-6 py-4">
                      ...
                      >
                        <RiDeleteBin5Line className="cursor-pointer text-2xl text-red-700" />
                      </button>
                    </td>
                  </tr>
                ))}
